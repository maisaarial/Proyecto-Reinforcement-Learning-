...
class ThiefEnv_cams_exitless(gym.Env):
    metadata = {"render_modes": ["human"]}

    def __init__(self, max_steps=1000, render_mode=None, nbr_cam=4):
        super().__init__()
        self.render_mode = render_mode
        self._physics_client = None
        self.max_steps = max_steps
        self.current_steps = 0
        self.nbr_cam = nbr_cam
    ...
    def _load_world(self):
        ...
        self.cameras = create_cameras([self.sensor_thief], self.types, nbr=self.nbr_cam) #watched = 2
    ...
    def step(self, action):
        #Update environment
        rotate_cameras(self.cameras, 0.05)
